...
public class Notebookscreen_recyclerview_adapter extends RecyclerView.Adapter<Notebookscreen_recyclerview_adapter.ViewHolder> {
    ...
    public void renameNoteBook(Model_Item_Notebook_screen modelItemNotebookScreen,int position, boolean update){
        listener.OnNotebookClicked(modelItemNotebookScreen,position,update);
    }
    public Model_Item_Notebook_screen getItemAtPos(int position){
        return item_model.get(position);
    }
